...
<div class="hidden md:block">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
        <?php foreach ($henvendelser_data as $row): ?>
            <?php
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-1 lg:px-6 py-4"><?php echo $loosning_beskrivelse; ?></td>
...
<div class="md:hidden">
    <?php foreach ($henvendelser_data as $row): ?>
        ...
        $status_color = $status_row['farge'];
        ?>
        <div class="relative border-b border-gray-600">
                ...
                <thead class="text-sm text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-5 text-right">
                            <a href="../ticket/update_ticket.php?id=<?php echo $id; ?>" class="text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg px-5 py-2 mb-2">
                                Rediger
                            </a>
                        </th>
                    </tr>
