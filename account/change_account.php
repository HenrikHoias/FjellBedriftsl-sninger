            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="space-y-2 md:space-y-3">
                        ...
                        <a href="../index.php" class="w-full hover:text-red-600 border-2 border-gray-700 hover:border-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center block">
                            Avbryt
                        </a>
                    </div>
                </form>
