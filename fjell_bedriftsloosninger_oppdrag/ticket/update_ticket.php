...
<div id="crud-modal" tabindex="-1" aria-hidden="true" class="overflow-y-auto overflow-x-hidden fixed flex justify-center items-center w-full max-h-full">
    <div class="flex items-center h-screen relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" style="min-width: 400px;">
            ...
            <form id="modal-form" method="POST" action="">
                <div class="grid gap-4 mb-4 grid-cols-1 ml-5 mr-1 mt-5">
                    <label id="modal-description" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:border-gray-500 dark:peer-checked:text-red-500 peer-checked:border-red-600 peer-checked:text-red-600 dark:text-white dark:bg-gray-600">
                        <div class="block">
                            <p class="w-full text-gray-500 dark:text-gray-400">
                                <b>HenvendelseID:</b> <?php echo $henvendelse_id; ?><br>
                                <b>BrukerID:</b> <?php echo $bruker_id; ?><br>
                                <b>Navn:</b> 
                                <?php 
                                // Hente brukernavn basert på bruker_id
                                ...
                                echo $bruker_navn; // Vis navnet tilhørende bruker_id
                                ?><br>
